...
class HtmlPrettyTableFormatter extends AbstractFormatter
{
    ...
    protected function getTable($error)
    {
        ...
        $errorTable = '<table style="border: 1px solid #aaa; border-collapse: collapse;"><tr>';
        $errorTable .= '<td colspan="3" style="background: #ff5332; padding: .6em">%s</td></tr>';
        ...
        foreach ($frames as $k => $frame) {
            ...
            $errorTable .= sprintf(
                '<tr style="border: 1px solid #ccc"><td style="padding: .2em" width="3%%">%d</td><td width="40%%">%s</td><td>%s</td></tr>',
                $k,
                $function,
                $fileline
            );
